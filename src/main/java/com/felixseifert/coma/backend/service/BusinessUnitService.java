...
public interface BusinessUnitService {
    ...
    BusinessUnit postBusinessUnit(BusinessUnit businessUnit);

    BusinessUnit putBusinessUnit(BusinessUnit businessUnit);

    void deleteBusinessUnit(BusinessUnit businessUnit) throws DependencyException;

    void removeBusinessUnitsForProductManager(Employee productManager);

    int count(Employee productManager);
